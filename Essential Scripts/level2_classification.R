#This script tests a variety of clustering methods for level 2 classification to see the results. 
#In the end, we decide on hierarchical clustering using Ward's method
